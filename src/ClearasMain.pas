...
begin
  ...
  begin
    ...
    begin
      Constraints.MinWidth := Constraints.MinWidth - ListView.Column[4].Width;
      ListView.Column[4].MinWidth := 0;
      ...
      repeat
        ...
        if (ListView.Column[4].Width <= COLUMN_DATE_WIDTH) then
          ListView.Column[4].Width := ListView.Column[4].Width - 1;

        Update;
        Sleep(0);
      until ((ListView.Column[4].Width <= 0) and (Width = EndOf));

      // Delete column
      ListView.Columns.Delete(4);
  ...
  begin
    ...
    // Add column
    ListView.Columns.Add.Caption := FLang.GetString(80);
    ...
    repeat
      ...
      Update;
      Sleep(0);
    until ((ListView.Column[4].Width >= COLUMN_DATE_WIDTH) and (Width = EndOf));

    ListView.Column[4].MinWidth := lwStartup.Column[4].Width;
    ListView.Column[4].MaxWidth := lwStartup.Column[4].Width;
    Constraints.MinWidth := Constraints.MinWidth + ListView.Column[4].Width;
