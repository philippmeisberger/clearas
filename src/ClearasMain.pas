...
begin
  lwList.Columns[1].Caption := FLang.GetString(92)+'('+IntToStr(Startup.ActCount)
...
begin 
  ...
  begin
    ...
    begin
      FLang.MessageBox(Flang.Format(44, [TClearas.GetBackupDir()]));
