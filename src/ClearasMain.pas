...
begin
  ...
  begin
    ...
    bActivate.Caption := GetString(93);
    bDeactivate.Caption := GetString(94);
    bExport.Caption := GetString(95);
    bDelete.Caption := GetString(96);
...
begin
  ...
  begin
    ...
    if (MessageBox(Format(48, [Startup.Item.Name]) +^J+ GetString(49)
      ...
      begin
        ...
        if ((not Exported) and Startup.Item.StartupUser and Startup.BackupExists) then
          Startup.DeleteBackup := (MessageBox(GetString(44), mtQuestion) = IDYES);
        ...
        begin
          ...
          FLang.MessageBox(FLang.GetString(96) + FLang.GetString(67), mtError);
      end;  //of if
  end;  //of with
...
begin
  ...
  begin
    // Confirm deletion of item
    if (MessageBox(Format(85, [Context.Item.Name]) +^J+ GetString(49)
       + GetString(50), mtConfirm) = IDYES) then
    begin
      ...
      begin
        ...
        MessageBox(GetString(96) + GetString(67), mtError);
    end;  //of begin
  end;  //of with
end;
...
begin
  ...
  begin
    ...
    FLang.MessageBox(FLang.GetString(93) + FLang.GetString(67), mtError);
end;
...
begin
  ...
  begin
    ...
    FLang.MessageBox(FLang.GetString(94) + FLang.GetString(67), mtError);
end;
         ...
         if (Item.SubItems[2] = '') then  //Schlüssel fehlt
            ...
            if (IsDouble(Item.SubItems[0], Item.Index) <> -1) then
               ...
               if Startup.Item.Enabled then                       //aktiviert?
                  ...
                  pmDeactivate.Caption := bActivate.Caption;  //Beschriftung ändern
                  end //of begin
               else
                  begin                                           //NEIN
                  bDelete.Default := False;
                  ...
                  bActivate.Default := True;
                  pmDeactivate.Enabled := True;
                  pmDeactivate.Caption := bDeactivate.Caption;  //Beschriftung ändern
                  end; //of if
...
begin
  if (PageControl.ActivePage = tsStartup) then
    ...
    if (PageControl.ActivePage = tsContext) then
      ...
      FLang.MessageBox(FLang.GetString(95) + FLang.GetString(67) +^J
